...
class Sheet:
 ...
 def add(self,id,ref,val,x,y,angle=0,unit=1,foot=None,dnp=False,extra=None):
  ...
  for n,v in (extra or {}).items():s.append(pr(n,v,x,y,True))
...
def build(dest,opa_rail,mosfet):
 ...
 (dest/'intended-main.json').write_text(json.dumps(s.intent,indent=2))
